...
.method constructor <init>(Lcom/google/gson/ObjectNavigator;Lcom/google/gson/FieldNamingStrategy2;ZLcom/google/gson/ParameterizedTypeHandlerMap;)V
    ...
    .line 42
    new-instance p1, Lcom/google/gson/MemoryRefStack;

    invoke-direct {p1}, Lcom/google/gson/MemoryRefStack;-><init>()V

    iput-object p1, p0, Lcom/google/gson/JsonSerializationContextDefault;->ancestors:Lcom/google/gson/MemoryRefStack;
...
.method serialize(Ljava/lang/Object;Ljava/lang/reflect/Type;Z)Lcom/google/gson/JsonElement;
    ...
    .line 62
    iget-object v0, p0, Lcom/google/gson/JsonSerializationContextDefault;->objectNavigator:Lcom/google/gson/ObjectNavigator;

    new-instance v1, Lcom/google/gson/ObjectTypePair;

    invoke-direct {v1, p1, p2, p3}, Lcom/google/gson/ObjectTypePair;-><init>(Ljava/lang/Object;Ljava/lang/reflect/Type;Z)V

    invoke-virtual {v0, v1, v7}, Lcom/google/gson/ObjectNavigator;->accept(Lcom/google/gson/ObjectTypePair;Lcom/google/gson/ObjectNavigator$Visitor;)V
